const apiKey = "8d9461078911e03d9cb6dbda7be21ff0"; // TMDB
const youtubeApiKey = "AIzaSyCzhHtS0rqLWIxI0BFXgyYeeu_nu5oEPlE"; // YouTube
let lastSearchTerm = "";
...
async function showMovieDetails(movieId) {
  ...
  try {
    ...
    // Fallback to YouTube if TMDB doesn't have trailer
    if (!trailerKey) {
      console.log("Using YouTube fallback for:", details.title);
      trailerKey = await fetchYouTubeTrailer(details.title);
    }
...
// 👇 Optional: Footer Scroll Animation
